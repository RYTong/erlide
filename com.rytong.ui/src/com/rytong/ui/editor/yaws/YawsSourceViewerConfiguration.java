 ...
 *
 */
public class YawsSourceViewerConfiguration extends SourceViewerConfiguration {

	private YawsEditor editor;

	public YawsSourceViewerConfiguration(YawsEditor editor) {
		super();
      this.editor = editor;
	}
