...
public class RytongUIPlugin extends AbstractUIPlugin {
	...
	public static String[] getAppDirs() {
		return new String[] { RytongUIConstants.APP_BIN_DIR,
				RytongUIConstants.APP_CONFIG_DIR,
				RytongUIConstants.APP_DRIVERS_DIR,
				RytongUIConstants.APP_EBIN_DIR, RytongUIConstants.APP_CERT_DIR,
				...
				RytongUIConstants.APP_SRC_DIR, RytongUIConstants.APP_WWW_DIR };
	}
